...
BT_PLUGIN_SINK_COMPONENT_CLASS_DESCRIPTION(memory_usage, "Computes the heap memory usage of ROS 2 nodes");

/* Set some of the `memory_usage` sink component class's optional methods */
BT_PLUGIN_SINK_COMPONENT_CLASS_INITIALIZE_METHOD(memory_usage, memory_usage_initialize);
BT_PLUGIN_SINK_COMPONENT_CLASS_FINALIZE_METHOD(memory_usage, memory_usage_finalize);
BT_PLUGIN_SINK_COMPONENT_CLASS_GRAPH_IS_CONFIGURED_METHOD(memory_usage, memory_usage_graph_is_configured);
...
BT_PLUGIN_SINK_COMPONENT_CLASS_DESCRIPTION(callback_duration, "Computes the callback durations of ROS 2 nodes");

/* Set some of the `output` sink component class's optional methods */
BT_PLUGIN_SINK_COMPONENT_CLASS_INITIALIZE_METHOD(callback_duration, callback_duration_initialize);
BT_PLUGIN_SINK_COMPONENT_CLASS_FINALIZE_METHOD(callback_duration, callback_duration_finalize);
BT_PLUGIN_SINK_COMPONENT_CLASS_GRAPH_IS_CONFIGURED_METHOD(callback_duration, callback_duration_graph_is_configured);