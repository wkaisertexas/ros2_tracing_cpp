...
std::string node_info_make_filename(const NodeInfo &node) { return "mem_" + node.procname + ".csv"; }
...
static bt_component_class_initialize_method_status memory_usage_initialize(
...
static void memory_usage_finalize(bt_self_component_sink *self_component_sink) {
...
/// is configured.
static bt_component_class_sink_graph_is_configured_method_status memory_usage_graph_is_configured(
...
static void memory_usage_calculator(struct MemoryUsage *memory_usage, const bt_message *message) {
